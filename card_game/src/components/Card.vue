...
src="https://cdnb.artstation.com/p/assets/images/images/018/433/397/large/anton-evsyukov-blood-elf.jpg?1559343941"/>
        ...
        <div class="rowCell glueBottom testCell">
            <div class="miniCell testCell">
                <p>
            <!-- разместить на фоне иконку, отображающую атаку. 
            Можно использовать иконки bootstrap, свои картинки или из интернета. 
            Текст с количеством атаки должен быть поверх это иконки -->
                    2</p>
            </div>
            <div class="miniCell testCell">
            <!-- разместить поверх картинки текст с количеством защиты -->
